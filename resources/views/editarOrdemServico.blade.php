  ...
  <div class="box-body">
    ...
    <div class="nav-tabs-custom">
      <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="#manutencao" data-toggle="tab">Equipamentos</a></li>
      </ul>
        ...
        <div class="active tab-pane" id="manutencao">
          ...
          <form role="form"  action="/manutencao/salvar" method="post">
            ...
            <div class="box-footer">
              <a href=/ordems><button type="button" class="btn btn-danger glyphicon glyphicon-remove">Cancelar</button></a>
              <button type="submit" class="btn btn-info pull-right glyphicon glyphicon-ok">Adicionar</button>
            </div>
            <!-- box-footer  -->
          </form>
                  ...
                  <form role="form"  action="/ordem/atualizar" method="post">
                    ...
                    <div class="row">
                      <div class="col-sm-4">
                        <div class="form-group">
                          <label>Termo:</label>
                          <input type="text" name="termo" class="form-control" value={{ $ordem->termo }}>
                        </div>
                      </div>
                          <input type="hidden" name="data_envio" class="form-control">
