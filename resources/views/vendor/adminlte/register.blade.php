...
<form class="modal-content animate" action="{{ url(config('adminlte.register_url', 'register')) }}" method="post">
  ...
  <div class="imgcontainer">
    ...
    <div class="container form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
      ...
      <div class="form-group has-feedback {{ $errors->has('name') ? 'has-error' : '' }}">
        <input type="text" name="name" value="{{ old('name') }}" placeholder="{{ trans('adminlte::adminlte.full_name') }}" required>
        @if ($errors->has('name'))
      ...
      <div class="form-group has-feedback {{ $errors->has('password_confirmation') ? 'has-error' : '' }}">
        <input type="password" name="password_confirmation" placeholder="{{ trans('adminlte::adminlte.retype_password') }}" required>
      ...
      <button class="btn-success" title="Registrar" type="submit">{{ trans('adminlte::adminlte.register') }}</button>
